...
// User? nullableUser = FirebaseAuth.instance.currentUser;
// User nonNullableUser = nullableUser ?? User();

// User user = FirebaseAuth.instance.currentUser;
// UserCredential userCredential = UserCredential.user!(user);
  ...
  setUp(() {
    ...
    when(mockFirebaseFirestore.collection("seller"))
